    ...
    astray.walk(ast, {
      ...
      JSXOpeningElement: {
        exit(node) {
          ...
          // if (importsMap[firstPart]) {
          //   console.log(`Missing import or built-in element: ${firstPart}`);
          //   return;
          // }

          componentInfo.instances.push(info);

          // const items = componentInfo.instances.filter((object) => { object.importInfo['local'] === "Textbox" });
          // console.log(`${firstPart} from ${importsMap[firstPart]}`);
